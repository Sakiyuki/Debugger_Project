...
namespace Debugger_Project.Controllers
{
    ...
    public class TicketNotificationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,TicketId,Created,NotificationBody,RecipeintId,SenderId,Read")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Created,NotificationBody,RecipeintId,SenderId,Read")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
